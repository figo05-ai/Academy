...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'لوحة التحكم - أكاديمية المكتب الفني'); ?></title>
        ...
        <div class="p-6 border-t border-glass-border shrink-0">
            <div class="flex items-center gap-3 mb-4">
                ...
                <div class="overflow-hidden">
                    <p class="text-sm font-bold text-text-primary truncate"><?php echo e(Auth::user()?->name ?? 'المستخدم'); ?></p>
                    <p class="text-xs text-text-muted truncate"><?php echo e(Auth::user()?->email ?? ''); ?></p>
                </div>
            </div>
    ...
    <div class="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header class="h-[100px] shrink-0 border-b border-glass-border bg-bg-primary/50 backdrop-blur-xl px-6 flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-xl md:text-2xl font-bold text-text-primary"><?php echo $__env->yieldContent('page_title', 'لوحة التحكم'); ?></h1>
            </div>
...
<?php /**PATH /mnt/Felo/Courses/learing/PHP/Laravel/Gorge/resources/views/layouts/app.blade.php ENDPATH**/ ?>