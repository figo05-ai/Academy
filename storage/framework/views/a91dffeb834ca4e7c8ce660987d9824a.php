    ...
    <div class="space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-bg-card border border-glass-border rounded-2xl p-6 md:p-8 flex items-center gap-6 shadow-lg">
                ...
                <div>
                    <div class="text-3xl font-black text-text-primary mb-1"><?php echo e($totalEnrolledCourses); ?></div>
            ...
            <div class="bg-bg-card border border-glass-border rounded-2xl p-6 md:p-8 flex items-center gap-6 shadow-lg">
                ...
                <div>
                    <div class="text-3xl font-black text-text-primary mb-1"><?php echo e($overallProgressPercentage); ?>%</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /mnt/Felo/Courses/learing/PHP/Laravel/Gorge/resources/views/Admin/users/dashboard.blade.php ENDPATH**/ ?>